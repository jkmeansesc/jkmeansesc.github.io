...
available和skip方法（以下代码正式写的时候要使用try catch，参考上面第一个代码块）
...
OutputStream完成复制（以下代码正式写的时候要使用try catch，参考上面第一个代码块）
...
public class BufferedWriterTest01 {
    public static void main(String[] args) throws Exception {
        ...
        BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(new FileOutputStream("D:\\005_Documents\\DailyShitTemp.txt", true)));
...
public class DataInputStreamTest01 {
    public static void main(String[] args) throws Exception {
        ...
        //创建输入流
        DataInputStream dis = new DataInputStream(new FileInputStream("D:\\005_Documents\\DailyShitTemp2" +
                ""));
...
public class PrintStreamTest01 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //可以改变输出方向
        System.setOut(new PrintStream(new FileOutputStream("D:\\005_Documents\\log"))); //log日志文件
        //再次输出
...
因为User实现了Serializable接口，JVM会特殊待遇：会给该类添加一个属性，static final long serialVersionUID = 一个值 ;
